...
// OF COURSE, IT SHOULD GO WITHOUT SAYING THAT THIS IS A VERY BASIC IMPLEMENTATION
// OF WHAT WOULD OTHERWISE BE A SOPHISTICATED NEURAL NETWORK DESIGNED TO LEARN AND ADAPT
